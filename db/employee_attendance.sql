...
(7, 12, '2025-05-30 04:42:01', NULL, 'late'),
(8, 11, '2025-05-30 05:04:05', '2025-05-30 05:13:06', 'late');
...
(86, 13, '2025-05-28 15:03:42', '2025-05-30 19:04:14', 'present'),
(88, 13, '2025-05-29 14:03:48', '2025-05-30 17:05:55', 'late'),
(89, 14, '2025-05-28 04:17:03', '2025-05-28 08:35:00', 'late'),
(90, 14, '2025-05-29 15:20:30', '2025-05-30 19:23:01', 'late'),
(91, 4, '2025-05-29 20:10:32', '2025-05-29 23:54:00', 'present'),
(106, 12, '2025-05-30 02:17:20', '2025-05-30 02:21:51', 'late'),
(107, 4, '2025-05-30 02:21:08', '2025-05-30 04:22:02', 'late'),
(116, 11, '2025-05-30 05:52:07', '2025-05-30 05:52:27', 'late');
...
INSERT INTO `settings` (`id`, `set_am_time_in`, `set_am_time_out`, `set_pm_time_in`, `set_pm_time_out`, `threshold_minute`) VALUES
(1, '04:50:00', '05:50:00', '17:30:00', '19:00:00', 15);
...
--
ALTER TABLE `afternoon_time_log`
  ADD CONSTRAINT `afternoon_time_log_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `users` (`id`);
